    ...
    <div className="flex min-h-screen bg-[#f8fafc]">
      ...
      <aside className="w-52 flex flex-col fixed inset-y-0 left-0 z-50 bg-white border-r border-[#e8ecf0]">
        ...
        <div className="px-4 py-4 border-b border-[#e8ecf0]">
          ...
          <button className="w-full flex items-center gap-2 px-2 py-1.5 rounded-[6px] hover:bg-[#f9fafb] transition-colors text-left">
            ...
            <ChevronDown className="w-3 h-3 text-[#9ca3af] flex-shrink-0" />
          </button>
        </div>
